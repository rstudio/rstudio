...
if not exist quarto (
  ...
  REM git clone --branch release/rstudio-apple-blossom https://github.com/quarto-dev/quarto.git ..\..\..\src\gwt\lib\quarto
  ...
  git clean -dfx
  git checkout main
  REM git checkout release/rstudio-apple-blossom
  git pull
  git rev-parse HEAD
  popd
)
