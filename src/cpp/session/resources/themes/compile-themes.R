...
.rs.addFunction("create_xterm_color_rules", function(background, foreground, isDark) {
   paste(sep = "\n",
         ...
         ".xtermCommand { text-decoration: underline; text-decoration-style: dotted; }", 
         sprintf(".xtermCommand:hover { text-decoration: none; background: #%s; }", if(isDark) "111" else "eee"),
         ".xtermCommandHidden { display: none; }", 
         sprintf(".xtermCommandVisible { margin-left: 5px; display: inline; cursor: pointer; color: green; background: #%s; }", if(isDark) "111" else "eee"), 
