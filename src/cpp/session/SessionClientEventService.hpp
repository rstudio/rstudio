...
public:
   ...
   rstudiocore::Error start(const std::string& clientId);
   void stop();
...
private:
   ...
   void addClientEvent(const rstudiocore::json::Object& eventObject);
   void setClientEventResult(rstudiocore::json::JsonRpcResponse* pResponse);
...
private:
   ...
   rstudiocore::json::Array clientEvents_ ;
};
