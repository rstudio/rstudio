 ...
 */
std::string UserPrefValues::sshKeyPath()
{
   return readPref<std::string>("ssh_key_path");
}

core::Error UserPrefValues::setSshKeyPath(std::string val)
{
   return writePref("ssh_key_path", val);
}
