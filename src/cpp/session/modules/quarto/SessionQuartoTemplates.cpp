...
// This class is responsible for discovering quarto document templates in
...
Error quartoGetTemplates(const json::JsonRpcRequest&,
...
core::Error initialize()
{
   ...
   initBlock.addFunctions()
      (bind(registerRpcMethod, "quarto_get_templates", quartoGetTemplates));
