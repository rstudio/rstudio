...
Error UserSettings::initialize()
{
   ...
   if (contextId().empty())
      setContextId(rstudiocore::system::generateShortenedUuid());
...
rstudiocore::json::Object UserSettings::uiPrefs() const
{
   std::string value = settings_.get(kUiPrefs, "{}");
   json::Value jsonValue;
   bool success = rstudiocore::json::parse(value, &jsonValue);
   if (success)
...
void UserSettings::setUiPrefs(const rstudiocore::json::Object& prefsObject)
{
...
{ 
   ...
   json::Array spellingCustomDicts = readPref<rstudiocore::json::Array>(prefs, "spelling_custom_dictionaries", rstudiocore::json::Array());
...
rstudiocore::FilePath UserSettings::initialWorkingDirectory() const
{
