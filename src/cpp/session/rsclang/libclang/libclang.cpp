   ...
   : pLib_(NULL)
{
   ...
   LOAD_CLANG_SYMBOL(getSkippedRanges)
   LOAD_CLANG_SYMBOL(disposeSourceRangeList)
   ...
   LOAD_CLANG_SYMBOL(createTranslationUnit2)
   LOAD_CLANG_SYMBOL(parseTranslationUnit2)
   ...
   LOAD_CLANG_SYMBOL(Type_getClassType)
   LOAD_CLANG_SYMBOL(Type_getSizeOf)
   LOAD_CLANG_SYMBOL(Type_getOffsetOf)
   LOAD_CLANG_SYMBOL(Type_getNumTemplateArguments)
   LOAD_CLANG_SYMBOL(Type_getTemplateArgumentAsType)
   LOAD_CLANG_SYMBOL(Type_getCXXRefQualifier)
   ...
   LOAD_CLANG_SYMBOL(getModuleForFile)
   ...
   LOAD_CLANG_SYMBOL(Module_isSystem)
   ...
   LOAD_CLANG_SYMBOL(CXXMethod_isConst)
   ...
   //LOAD_CLANG_SYMBOL(CompileCommand_getNumMappedSources)
   //LOAD_CLANG_SYMBOL(CompileCommand_getMappedSourcePath)
   //LOAD_CLANG_SYMBOL(CompileCommand_getMappedSourceContent)

   LOAD_CLANG_SYMBOL(getBuildSessionTimestamp)
   LOAD_CLANG_SYMBOL(VirtualFileOverlay_create)
   LOAD_CLANG_SYMBOL(VirtualFileOverlay_addFileMapping)
   LOAD_CLANG_SYMBOL(VirtualFileOverlay_setCaseSensitivity)
   LOAD_CLANG_SYMBOL(VirtualFileOverlay_writeToBuffer)
   LOAD_CLANG_SYMBOL(VirtualFileOverlay_dispose)
   LOAD_CLANG_SYMBOL(ModuleMapDescriptor_create)
   LOAD_CLANG_SYMBOL(ModuleMapDescriptor_setFrameworkModuleName)
   LOAD_CLANG_SYMBOL(ModuleMapDescriptor_setUmbrellaHeader)
   LOAD_CLANG_SYMBOL(ModuleMapDescriptor_writeToBuffer)
   LOAD_CLANG_SYMBOL(ModuleMapDescriptor_dispose)
}
