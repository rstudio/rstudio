...
Error appendToFile(const rstudiocore::FilePath& filePath,
...
template <typename T>
Error appendStructToFile(const rstudiocore::FilePath& filePath,
                         const T& data)
{
   using namespace boost::system::errc ;
...
template <typename T>
Error readStructVectorFromFile(const rstudiocore::FilePath& filePath,
...
Error writeStringToFile(const rstudiocore::FilePath& filePath,
...
Error readStringFromFile(const rstudiocore::FilePath& filePath,
                         std::string* pStr,
                         string_utils::LineEnding lineEnding=string_utils::LineEndingPassthrough,
                         int startLine = 0,
                         int endLine = 0,
