 ...
 */
  ...
  * such as Docker, Kubernetes, Apptainer, Singularity, or other container platforms.
  * 
  * This function checks:
  * - presence of /.dockerenv, /run/.containerenv, or /.singularity.d files/folders
  * - common environment variables (KUBERNETES_SERVICE_HOST, APPTAINER_CONTAINER, etc.)
  *
  * @return true if the current process is running inside a container, false otherwise.
  */
