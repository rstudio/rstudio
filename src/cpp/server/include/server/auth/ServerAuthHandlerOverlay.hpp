...
core::Error lockUser(boost::asio::io_context& ioService,
                     const std::string& username,
                     bool force = false);

core::Error unlockUser(boost::asio::io_context& ioService,
                       const std::string& username,
                     bool force = false);

core::Error setAdmin(boost::asio::io_context& ioService,
                     const std::string& username,
                     bool isAdmin);
