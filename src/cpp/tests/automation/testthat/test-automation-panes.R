# tests related to zooming panes and columns with and without sidebar visible
...
.rs.test("Source columns can be created and closed", {
   ...
   # Verify the first additional source column exists
   ...
   # Verify the second additional source column exists
   ...
   # Verify both source columns are visible
