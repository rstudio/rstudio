   ...
   *pValue = rstudiocore::json::Value();
   ...
   switch(TYPEOF(vectorSEXP))
   {
      ...
      case CPLXSXP:
      {
         ...
         {
            rstudiocore::json::Object jsonComplex ;
            jsonComplex["r"] = real;
...
Error jsonValueArrayFromList(SEXP listSEXP, rstudiocore::json::Value* pValue)
{
   // value array to return
   rstudiocore::json::Array jsonValueArray;
   ...
   for (int i=0; i<listLength; i++)
   {
      ...
      // extract the value
      rstudiocore::json::Value jsonValue ;
...
bool isNamedList(SEXP listSEXP)
{
   ...
   int nameCount = std::count_if(fieldNames.begin(), 
                                 fieldNames.end(),
                                 &rstudiocore::string_utils::stringNotEmpty);
                                ...
                                rstudiocore::json::Value* pValue)
{
   ...
   rstudiocore::json::Object jsonObject ;
...
//   
Error jsonObjectFromList(SEXP listSEXP, rstudiocore::json::Value* pValue)  
{
...
// and returned true for this list (validates a name for each element)
//   
Error jsonObjectArrayFromDataFrame(SEXP listSEXP, rstudiocore::json::Value* pValue)
{      
   // get the names of the list elements
   std::vector<std::string> fieldNames ;
   Error error = sexp::getNames(listSEXP, &fieldNames);
   ...
   rstudiocore::json::Array jsonObjectArray ;
...
Error jsonValueFromScalar(SEXP scalarSEXP, rstudiocore::json::Value* pValue)
{
   // verify length
...
Error jsonValueFromVector(SEXP vectorSEXP, rstudiocore::json::Value* pValue)
{
   ...
   rstudiocore::json::Array vectorValues ;
   for (int i=0; i<vectorLength; i++)
   {
      rstudiocore::json::Value elementValue ;
...
Error jsonValueFromList(SEXP listSEXP, rstudiocore::json::Value* pValue)
{
...
Error jsonValueFromObject(SEXP objectSEXP, rstudiocore::json::Value* pValue)
{
