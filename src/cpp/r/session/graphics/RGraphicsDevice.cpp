...
Error saveSnapshot(const rstudiocore::FilePath& snapshotFile,
                   const rstudiocore::FilePath& imageFile)
{
...
Error restoreSnapshot(const rstudiocore::FilePath& snapshotFile)
{
   // ensure we are active
   Error error = makeActive();
   if (error)
