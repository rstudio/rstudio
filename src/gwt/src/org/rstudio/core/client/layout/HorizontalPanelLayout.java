...
/**
 * Use in place of HorizontalPanel so assistive technology sees that tables are being
 * used for layout (presentation), and not for displaying tabular data.
 */
public class HorizontalPanelLayout extends HorizontalPanel
{
