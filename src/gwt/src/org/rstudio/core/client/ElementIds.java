...
public class ElementIds
{
   ...
   public final static String VISUAL_MD_DIV_TAB_CALLOUT = "visual_md_div_tab_callout";
   public final static String VISUAL_MD_DIV_TAB_ATTRIBUTES = "visual_md_div_tab_attributes";
   public final static String VISUAL_MD_DIV_CALLOUT_CAPTION = "visual_md_div_callout_caption";
   public final static String VISUAL_MD_DIV_CALLOUT_ICON = "visual_md_div_callout_icon";
