...
@Singleton
public class RSConnectAuthSatellite extends SatelliteApplication
{
   public static final String NAME = "rsconnect_auth";
   
   @Inject
   public RSConnectAuthSatellite(RSConnectAuthView view,
                                 Satellite satellite,
