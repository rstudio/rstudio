/*
 * QuartoDiscoveredTemplateItem.java
 *
...
public class QuartoDiscoveredTemplateItem extends Composite
{
   public QuartoDiscoveredTemplateItem(RmdDocumentTemplate template)
   {
      template_ = template;
