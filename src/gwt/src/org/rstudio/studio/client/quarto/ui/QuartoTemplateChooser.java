...
public class QuartoTemplateChooser extends Composite
{
   ...
   interface RmdTemplateChooserUiBinder extends
         UiBinder<Widget, QuartoTemplateChooser>
   {
   }

   public QuartoTemplateChooser(QuartoServerOperations server)
   {
      ...
      listTemplates_.addChangeHandler(new ChangeHandler()
      {
         ...
         public void onChange(ChangeEvent evt)
         {
            ...
            QuartoDiscoveredTemplateItem item = listTemplates_.getSelectedItem();
            ...
            new ServerRequestCallback<JsArray<RmdDocumentTemplate>>()
      {
         ...
         public void onResponseReceived(JsArray<RmdDocumentTemplate> templates)
         {
            ...
            for (RmdDocumentTemplate template: templates_)
            {
               ...
               listTemplates_.addItem(new QuartoDiscoveredTemplateItem(template), 
         ...
         public void onError(ServerError error)
         {
            RStudioGinjector.INSTANCE.getGlobalDisplay().showErrorMessage(
                  "Quarto Templates Not Found",
                  "An error occurred while looking for Quarto templates");
   ...
   {
      return new CaptionWithHelp("Template:",
   ...
   @UiField WidgetListBox<QuartoDiscoveredTemplateItem> listTemplates_;
