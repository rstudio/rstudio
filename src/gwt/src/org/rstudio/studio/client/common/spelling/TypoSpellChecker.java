...
public class TypoSpellChecker
{
                   ...
                   UIPrefs uiPrefs)
   {
      ...
      Debug.log("Attempting to load typo.js");
      ExternalJavaScriptLoader.Callback loadTypoCallback = () -> {
         Debug.log("Successfully loaded typo.js");
         TypoNative n = new TypoNative("en_US");
         boolean isCorrect = n.check("spelled");
         Debug.log("spelled is correct: " + isCorrect);
         Debug.log("splld is correct: " + n.check("splld"));
         Debug.log("spelld suggestions: " + String.join(", ", n.suggest("splld")));
      };
      new ExternalJavaScriptLoader(TypoResources.INSTANCE.typojs().getSafeUri().asString())
         .addCallback(loadTypoCallback);
   }
