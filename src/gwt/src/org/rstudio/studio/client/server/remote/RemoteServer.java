...
{ 
   ...
   @Override
   public void pandocGetBibliography(String file, ServerRequestCallback<JavaScriptObject> callback)
   {
      sendRequest(RPC_SCOPE, PANDOC_GET_BIBLIOGRAPHY, file, callback);
   }
