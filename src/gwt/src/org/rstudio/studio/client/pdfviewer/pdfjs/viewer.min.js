...
d&&clearInterval(d._loadingInterval);for(var e=document.getElementById("viewer");e.hasChildNodes();)e.removeChild(e.lastChild);var f;try{f=new PDFJS.PDFDoc(a)}catch(g){this.error("An error occurred while reading the PDF.",g)}var i=f.numPages,h=f.fingerprint,k=null;document.getElementById("numPages").textContent=i;document.getElementById("pageNumber").max=i;PDFView.documentFingerprint=h;var n=PDFView.store=new Settings(h);if(n.get("exists",!1))var h=n.get("page","1"),k=n.get("zoom",PDFView.currentScale),
l=n.get("scrollLeft","0"),n=n.get("scrollTop","0"),k="page="+h+"&zoom="+k+","+l+","+n;for(var n=this.pages=[],l={},r=this.thumbnails=[],j=1;j<=i;j++){var h=f.getPage(j),o=new PageView(e,h,j,h.width,h.height,h.stats,this.navigateTo.bind(this)),p=new ThumbnailView(d,h,j,h.width/h.height);c(o,p);n.push(o);r.push(p);h=h.ref;l[h.num+" "+h.gen+" R"]=j}this.pagesRefMap=l;this.destinations=f.catalog.destinations;f.catalog.documentOutline&&(this.outline=new DocumentOutlineView(f.catalog.documentOutline),document.getElementById("outlineSwitch").removeAttribute("disabled"),
this.switchSidebarView("outline"));this.currentScale=0;this.currentScaleValue=null;this.initialBookmark?(this.setHash(this.initialBookmark),this.initialBookmark=null):k?this.setHash(k):b&&(this.parseScale(b,!0),this.page=1);this.page>this.pages.length&&(this.page=this.pages.length);PDFView.currentScale===kUnknownScale&&this.parseScale(kDefaultScale,!0);updateThumbViewArea()},setHash:function(a){if(a)if(0<=a.indexOf("=")){var b=PDFView.parseQueryString(a);if("nameddest"in b)PDFView.navigateTo(b.nameddest);
else if("page"in b)if(this.page=a=b.page|0||1,"zoom"in b){var b=b.zoom.split(","),c=b[0],d=parseFloat(c);d&&(c=d/100);this.pages[a-1].scrollIntoView([null,{name:"XYZ"},b[1]|0,b[2]|0,c])}else this.page=b.page}else/^\d+$/.test(a)?this.page=a:PDFView.navigateTo(unescape(a))},switchSidebarView:function(a){var b=document.getElementById("sidebarScrollView"),c=document.getElementById("outlineScrollView"),d=document.getElementById("thumbsSwitch"),e=document.getElementById("outlineSwitch");switch(a){case "thumbs":b.removeAttribute("hidden");
c.setAttribute("hidden","true");d.setAttribute("data-selected",!0);e.removeAttribute("data-selected");updateThumbViewArea();break;case "outline":b.setAttribute("hidden","true"),c.removeAttribute("hidden"),d.removeAttribute("data-selected"),e.setAttribute("data-selected",!0)}},pinSidebar:function(){document.getElementById("sidebar").classList.toggle("pinned")},getVisiblePages:function(){for(var a=this.pages,b=[],c=10,d=window.pageYOffset,e=1;e<=a.length;++e){var f=a[e-1],f=f.height*f.scale+10;if(c+
f>d)break;c+=f}for(d=window.pageYOffset+window.innerHeight;e<=a.length&&c<d;++e)f=a[e-1],b.push({id:f.id,y:c,view:f}),c+=f.height*f.scale+10;return b},getVisibleThumbs:function(){for(var a=this.thumbnails,b=[],c=document.getElementById("sidebarScrollView"),d=5,e=c.scrollTop,f=1;f<=a.length;++f){var g=a[f-1],g=g.height*g.scaleY+5;if(d+g>e)break;d+=g}for(c=e+c.clientHeight;f<=a.length&&d<c;++f)e=a[f-1],b.push({id:e.id,y:d,view:e}),d+=e.height*e.scaleY+5;return b},parseQueryString:function(a){for(var a=
a.split("&"),b={},c=0;c<a.length;++c){var d=a[c].split("="),e=1<d.length?d[1]:null;b[unescape(d[0])]=unescape(e)}return b}},PageView=function(a,b,c,d,e,f){function g(a,b){function c(a,b){a.href=PDFView.getDestinationHash(b);a.onclick=function(){b&&PDFView.navigateTo(b);return!1}}function d(a,c){var e=document.createElement(a);e.style.left=Math.floor(c.x-i.x)*b+"px";e.style.top=Math.floor(c.y-i.y)*b+"px";e.style.width=Math.ceil(c.width*b)+"px";e.style.height=Math.ceil(c.height*b)+"px";return e}function e(a,
c){var f=document.createElement("section");f.className="annotComment";var h=d("img",c);h.src=kImageDirectory+a.toLowerCase()+".svg";var g=document.createElement("div");g.setAttribute("hidden",!0);var k=document.createElement("h1"),l=document.createElement("p");g.style.left=Math.floor(c.x-i.x+c.width)*b+"px";g.style.top=Math.floor(c.y-i.y)*b+"px";k.textContent=c.title;if(c.content){for(var j=document.createElement("span"),o=c.content.split("\n"),m=0,p=o.length;m<p;++m)j.appendChild(document.createTextNode(o[m])),
m<p-1&&j.appendChild(document.createElement("br"));l.appendChild(j);h.addEventListener("mouseover",function(){this.nextSibling.removeAttribute("hidden")},!1);h.addEventListener("mouseout",function(){this.nextSibling.setAttribute("hidden",!0)},!1)}else g.setAttribute("hidden",!0);g.appendChild(k);g.appendChild(l);f.appendChild(h);f.appendChild(g);return f}for(var f=a.getAnnotations(),g=0;g<f.length;g++){var m=f[g];switch(m.type){case "Link":var q=d("a",m);q.href=m.url||"";m.url||c(q,"dest"in m?m.dest:
null);h.appendChild(q);break;case "Text":(m=e(m.name,m))&&h.appendChild(m)}}}this.id=c;this.content=b;var i=this.content.view;this.x=i.x;this.y=i.y;this.width=i.width;this.height=i.height;b=document.createElement("a");b.name=""+this.id;var h=document.createElement("div");h.id="pageContainer"+this.id;h.className="page";a.appendChild(b);a.appendChild(h);this.update=function(a){this.scale=a||this.scale;h.style.width=this.width*this.scale+"px";for(h.style.height=this.height*this.scale+"px";h.hasChildNodes();)h.removeChild(h.lastChild);
h.removeAttribute("data-loaded");delete this.canvas;this.loadingIconDiv=document.createElement("div");this.loadingIconDiv.className="loadingIcon";h.appendChild(this.loadingIconDiv)};this.getPagePoint=function(a,b){var c=PDFView.currentScale;return this.content.rotatePoint(a/c,b/c)};this.scrollIntoView=function(a){if(a){var b=0,c=0,d=0,e=0,f;f=0;switch(a[1].name){case "XYZ":b=a[2];c=a[3];f=a[4];break;case "Fit":case "FitB":f="page-fit";break;case "FitH":case "FitBH":c=a[2];f="page-width";break;case "FitV":case "FitBV":b=
a[2];f="page-height";break;case "FitR":b=a[2];c=a[3];d=a[4]-b;e=a[5]-c;a=(window.innerWidth-kScrollbarPadding)/d/kCssUnits;f=(window.innerHeight-kScrollbarPadding)/e/kCssUnits;f=Math.min(a,f);break;default:return}var g=[this.content.rotatePoint(b,c),this.content.rotatePoint(b+d,c+e)];f&&f!==PDFView.currentScale?PDFView.parseScale(f,!0):PDFView.currentScale===kUnknownScale&&PDFView.parseScale(kDefaultScale,!0);setTimeout(function(){var a=PDFView.currentScale,b=Math.min(g[0].x,g[1].x),c=Math.min(g[0].y,
g[1].y),d=Math.abs(g[0].x-g[1].x),e=Math.abs(g[0].y-g[1].y),f=document.createElement("div");f.style.position="absolute";f.style.left=Math.floor(b*a)+"px";f.style.top=Math.floor(c*a)+"px";f.style.width=Math.ceil(d*a)+"px";f.style.height=Math.ceil(e*a)+"px";h.appendChild(f);f.scrollIntoView(!0);h.removeChild(f)},0)}else h.scrollIntoView(!0)};this.drawingRequired=function(){return!h.querySelector("canvas")};this.draw=function(a){if(this.drawingRequired()){var b=document.createElement("canvas");b.id=
"page"+this.id;b.mozOpaque=!0;h.appendChild(b);this.canvas=b;var c=null;PDFJS.disableTextLayer||(c=document.createElement("div"),c.className="textLayer",h.appendChild(c));var c=c?new TextLayerBuilder(c):null,i=this.scale;b.width=d*i;b.height=e*i;var j=b.getContext("2d");j.save();j.fillStyle="rgb(255, 255, 255)";j.fillRect(0,0,b.width,b.height);j.restore();j.translate(-this.x*i,-this.y*i);var o=this;f.begin=Date.now();this.content.startRendering(j,function(b){o.loadingIconDiv&&(h.removeChild(o.loadingIconDiv),
delete o.loadingIconDiv);b&&PDFView.error("An error occurred while rendering the page.",b);o.updateStats();if(o.onAfterDraw)o.onAfterDraw();cache.push(o);a()},c);g(this.content,this.scale);h.setAttribute("data-loaded",!0)}else this.updateStats(),a()};this.updateStats=function(){var a=f.compile,b=f.fonts,a="Time to compile/fonts/render: "+(a-f.begin)+"/"+(b-a)+"/"+(f.render-b)+" ms";document.getElementById("info").textContent=a}},ThumbnailView=function(a,b,c,d){function e(){var a=document.createElement("canvas");
a.id="thumbnail"+c;a.mozOpaque=!0;a.width=i;a.height=h;l.setAttribute("data-loaded",!0);l.appendChild(a);var d=a.getContext("2d");d.save();d.fillStyle="rgb(255, 255, 255)";d.fillRect(0,0,a.width,a.height);d.restore();a=b.view;d.translate(-a.x*k,-a.y*n);l.style.width=a.width*k+"px";l.style.height=a.height*n+"px";l.style.lineHeight=a.height*n+"px";return d}var f=document.createElement("a");f.href=PDFView.getAnchorUrl("#page="+c);f.onclick=function(){PDFView.page=c;return!1};var g=b.view;this.width=
g.width;this.height=g.height;this.id=c;var i=1<=d?134:134*d,h=1>=d?134:134/d,k=this.scaleX=i/this.width,n=this.scaleY=h/this.height,l=document.createElement("div");l.id="thumbnailContainer"+c;l.className="thumbnail";d=document.createElement("div");d.id="thumbnailLabel"+c;d.className="thumbnailLabelContainer";g=document.createElement("span");g.innerHTML=c;g.className="thumbnailLabel";d.appendChild(g);f.appendChild(l);f.appendChild(d);a.appendChild(f);this.hasImage=!1;this.drawingRequired=function(){return!this.hasImage};
this.draw=function(a){if(this.hasImage)a();else{var c=e();b.startRendering(c,function(){a()});this.hasImage=!0}};this.setImage=function(a){if(!this.hasImage&&a){var b=e();b.drawImage(a,0,0,a.width,a.height,0,0,b.canvas.width,b.canvas.height);this.hasImage=!0}}},DocumentOutlineView=function(a){function b(a,b){a.href=PDFView.getDestinationHash(b.dest);a.onclick=function(){PDFView.navigateTo(b.dest);return!1}}for(a=[{parent:document.getElementById("outlineView"),items:a}];0<a.length;){var c=a.shift(),
d,e=c.items.length;for(d=0;d<e;d++){var f=c.items[d],g=document.createElement("div");g.className="outlineItem";var i=document.createElement("a");b(i,f);i.textContent=f.title;g.appendChild(i);0<f.items.length&&(i=document.createElement("div"),i.className="outlineItems",g.appendChild(i),a.push({parent:i,items:f.items}));c.parent.appendChild(g)}}},TextLayerBuilder=function(a){this.textLayerDiv=a;this.beginLayout=function(){this.textDivs=[];this.textLayerQueue=[]};this.endLayout=function(){function a(){if(0===
d.length)clearInterval(f),g=!0;else{var b=d.shift();0<b.dataset.textLength&&(e.appendChild(b),1<b.dataset.textLength&&(CustomStyle.setProp("transform",b,"scale("+b.dataset.canvasWidth/b.offsetWidth+", 1)"),CustomStyle.setProp("transformOrigin",b,"0% 0%")))}}function c(){g?window.removeEventListener("scroll",c,!1):(clearInterval(f),clearTimeout(k),k=setTimeout(function(){f=setInterval(a,i)},h))}var d=this.textDivs,e=this.textLayerDiv,f=null,g=!1,i=0,h=500,f=setInterval(a,i),k=null;window.addEventListener("scroll",
c,!1)};this.appendText=function(a,c,d){var e=document.createElement("div"),d=d*a.geom.vScale;e.dataset.canvasWidth=a.canvasWidth*a.geom.hScale;e.dataset.fontName=c;e.style.fontSize=d+"px";e.style.left=a.geom.x+"px";e.style.top=a.geom.y-d+"px";e.textContent=PDFJS.bidi(a,-1);e.dir=a.direction;e.dataset.textLength=a.length;this.textDivs.push(e)}};
