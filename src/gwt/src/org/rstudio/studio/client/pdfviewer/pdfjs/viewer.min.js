...
"0"),k="page="+h+"&zoom="+k+","+l+","+n;for(var n=this.pages=[],l={},r=this.thumbnails=[],j=1;j<=i;j++){var h=f.getPage(j),o=new PageView(e,h,j,h.width,h.height,h.stats,this.navigateTo.bind(this)),p=new ThumbnailView(d,h,j,h.width/h.height);c(o,p);n.push(o);r.push(p);h=h.ref;l[h.num+" "+h.gen+" R"]=j}this.pagesRefMap=l;this.destinations=f.catalog.destinations;f.catalog.documentOutline&&(this.outline=new DocumentOutlineView(f.catalog.documentOutline),document.getElementById("outlineSwitch").removeAttribute("disabled"),
