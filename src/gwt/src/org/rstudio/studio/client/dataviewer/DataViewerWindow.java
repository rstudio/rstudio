...
@Singleton
public class DataViewerWindow extends SatelliteWindow
                              implements DataTableView
{

   @Inject
   public DataViewerWindow(Provider<EventBus> pEventBus,
                           Provider<FontSizeManager> pFSManager, 
                           Provider<DataViewerPresenter> pPresenter)
   {
   ...
   private Provider<DataViewerPresenter> pPresenter_;
}