...
public class CodeBrowserEditingTarget implements EditingTarget
{
   ...
   public CodeBrowserEditingTarget(SourceServerOperations server,
                                  ...
                                  TextEditingTarget.DocDisplay docDisplay)
   {
      server_ = server;
      commands_ = commands;
   ...
   {
      return new CodeBrowserEditingTargetWidget(commands_, docDisplay_);
   }
   ...
   private TextEditingTarget.DocDisplay docDisplay_;
