...
public class DataImportOptionsUiArrow extends DataImportOptionsUi
{
   ...
   private static DataImportOptionsUiArrowUiBinder uiBinder = GWT
         .create(DataImportOptionsUiArrowUiBinder.class);

   interface DataImportOptionsUiArrowUiBinder
         extends UiBinder<Widget, DataImportOptionsUiArrow>
   {
   }
   ...
   @Override
   public DataImportOptionsArrow getOptions()
   {
