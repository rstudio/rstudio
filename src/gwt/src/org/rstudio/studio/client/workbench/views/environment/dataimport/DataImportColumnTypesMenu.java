...
public class DataImportColumnTypesMenu extends PopupPanel
{
   ...
   public DataImportColumnTypesMenu()
   {
      ...
      menuItems_.add(new MenuItem("include", (Widget)include_)); //$NON-NLS-1$
      menuItems_.add(new MenuItem("skip", (Widget)skip_)); //$NON-NLS-1$
      menuItems_.add(new MenuItem("only", (Widget)only_)); //$NON-NLS-1$
      menuItems_.add(new MenuItem("guess", (Widget)guess_)); //$NON-NLS-1$
      menuItems_.add(new MenuItem("character", (Widget)character_)); //$NON-NLS-1$
      menuItems_.add(new MenuItem("double", (Widget)double_)); //$NON-NLS-1$
      menuItems_.add(new MenuItem("integer", (Widget)integer_)); //$NON-NLS-1$
      menuItems_.add(new MenuItem("numeric", (Widget)numeric_)); //$NON-NLS-1$
      menuItems_.add(new MenuItem("logical", (Widget)logical_)); //$NON-NLS-1$
      menuItems_.add(new MenuItem("date", (Widget)date_)); //$NON-NLS-1$
      menuItems_.add(new MenuItem("time", (Widget)time_)); //$NON-NLS-1$
      menuItems_.add(new MenuItem("dateTime", (Widget)dateTime_)); //$NON-NLS-1$
      menuItems_.add(new MenuItem("factor", (Widget)factor_)); //$NON-NLS-1$
