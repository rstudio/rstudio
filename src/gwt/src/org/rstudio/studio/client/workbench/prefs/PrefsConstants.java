...
public interface PrefsConstants extends com.google.gwt.i18n.client.Messages {
    ...
    String assistantSelectLabel();
    String assistantPaneName();
    String assistantNoneInfo();
    String projectAssistantDefaultInfo(String globalAssistant);
    String projectChatProviderDefaultInfo(String globalChatProvider);
    String copilotDisplayName();
    String copilotPaneName();
    String copilotIndexingHeader();
    String copilotCompletionsHeader();
    String copilotSuggestionsHeader();
    String copilotSuggestionsShortcutHint(String modifier);
    String assistantCompletionsHeader();
    String assistantSuggestionsHeader();
    String assistantSuggestionsRequestAcceptHint();
    String assistantSuggestionsDismissHint();
    String assistantQuickReferenceHeader();
    String assistantNesCollapseLabel();
    String assistantNesCollapseDescription();
    String assistantCompletionsDelayLabel();
    String assistantLoadingMessage();
    String assistantDiagnosticReportProgressLabel();
    String assistantSignedInAsLabel(String user);
    String assistantShowErrorLabel();
    String assistantSignInLabel();
    String assistantSignOutLabel();
    String assistantRefreshLabel();
    String assistantDiagnosticsLabel();
    String assistantProjectOptionsLabel();
    String assistantStatusDialogCaption();
    String assistantUnexpectedError();
    String assistantStartupError();
    String assistantAgentNotRunning();
    String assistantAgentNotEnabled();
    String assistantNotSignedIn();
    String assistantUnknownResponse(String response);
    String assistantDisabledInProject(String assistantName);
    String assistantConfiguredInProject(String assistantName);
    String codeAssistantDisabledInProject();
    String assistantTabPanel();
    ...
    String positAssistantUnsupportedVersionTitle();
    String positAssistantUnsupportedVersionMessage();
    String positAssistantUnsupportedProtocolTitle();
    String positAssistantUnsupportedProtocolMessage();
    String positAssistantManifestUnavailableTitle();
    String positAssistantManifestUnavailableMessage();
