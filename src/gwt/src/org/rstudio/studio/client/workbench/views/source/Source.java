...
import org.rstudio.studio.client.workbench.views.source.editors.text.FileTypeChangedEvent;
import org.rstudio.studio.client.workbench.views.source.editors.text.FileTypeChangedHandler;
                             ...
                             BeforeShowHandler
{
   ...
   private void restoreDocuments(Session session)
   {
                        ...
                        session.getSessionInfo().getClientState())
      {
         ...
         protected void onInit(Integer value)
         {
            ...
            if (index >= 0 && view_.getTabCount() > index)
               view_.selectTab(value.intValue());
         }
