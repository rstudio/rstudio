...
public class BuildClearButton extends Composite
{
   @Inject
   public BuildClearButton(Commands commands)
   {
      ...
      AppCommand buildCommand = commands.buildClear();
