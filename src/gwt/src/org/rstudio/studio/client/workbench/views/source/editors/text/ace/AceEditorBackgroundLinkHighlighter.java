            ...
            MouseMoveHandler
{
   ...
   private void navigateToUrl(String url)
   {
      ...
      if (match != null)
      {
         ...
         {
            globalDisplay_.openWindow("https://www.github.com/" + org_repo + "/issues/" + issue);
         } 
   ...
   // constants
   static Pattern kIssueLinkPattern = Pattern.create("((?:github|gitlab)::)?([-a-zA-Z0-9.]+/[-a-zA-Z0-9.]+)?#([0-9]+)");
}
