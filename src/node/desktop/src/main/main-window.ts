...
export function trackWindowMaximizedState(window: BrowserWindow): () => boolean {
  let windowWasMaximized = window.isMaximized();
  window.on('maximize', () => {
...
export class MainWindow extends GwtWindow {
  ...
  private wasWindowMaximized = () => false;
  ...
  constructor(url: string) {
    ...
    this.wasWindowMaximized = trackWindowMaximizedState(this.window);
  ...
  willRestoreMaximized(): boolean {
    return process.platform === 'win32' && this.wasWindowMaximized();
  }
