...
import { toReleaseSlug, isValidSlug, isReleaseBuild, resolveReleaseName, resolveWhatsNewContentPath } from './whats-new-utils';
...
export class SessionLauncher {
  ...
  private shouldShowWhatsNew(): boolean {
    ...
    const state = new WhatsNewState();
    if (state.hasSeenRelease(releaseName, info.RSTUDIO_VERSION_PATCH)) {
      return false;
    }
