...
export class SessionLauncher {
  ...
  private shouldShowWhatsNew(): boolean {
    ...
    // Resolve the impure inputs here, then let the pure decision function apply
    // the precedence rules (see evaluateWhatsNewVisibility for the ordering).
    return evaluateWhatsNewVisibility({
      contentAvailable: isValidSlug(slug) && resolveWhatsNewContentPath(slug) !== null,
      forceShow: getenv('RSTUDIO_SHOW_WHATS_NEW') !== '',
