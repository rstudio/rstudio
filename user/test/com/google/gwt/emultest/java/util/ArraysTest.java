...
public class ArraysTest extends EmulTestBase {
  ...
  public void testCopyOfBoolean() {
    ...
    assertEquals(new boolean[] {true, true}, ret);
    ...
    assertEquals(new boolean[0], ret);
  ...
  public void testCopyOfFloat() {
    ...
    ret = Arrays.copyOf(a1, 2);
    assertEquals(new float[] {0.5f, 1.25f}, ret);
  ...
  public void testCopyOfShort() {
    ...
    ret = Arrays.copyOf(a1, 2);
    assertEquals(new short[] {9, 8}, ret);
  ...
  public void testCopyOfObject() {
    ...
    ret = Arrays.copyOf(a1, 2);
    assertEquals(new Object[] {null, obj1}, ret);
  ...
  public void testCopyOfRangeBoolean() {
    ...
    assertEquals(new boolean[] {false, true}, ret);

    ret = Arrays.copyOfRange(a1, 3, 6);
    assertEquals(new boolean[] {true, true, false}, ret);
  ...
  public void testCopyOfRangeByte() {
    ...
    ret = Arrays.copyOfRange(a1, 2, 4);
    assertEquals(new byte[] {7, 5}, ret);

    ret = Arrays.copyOfRange(a1, 3, 6);
    assertEquals(new byte[] {5, 1, 0}, ret);
  ...
  public void testCopyOfRangeChar() {
    ...
    ret = Arrays.copyOfRange(a1, 2, 4);
    assertEquals(new char[] {7, 5}, ret);

    ret = Arrays.copyOfRange(a1, 3, 6);
    assertEquals(new char[] {5, 1, 0}, ret);
  ...
  public void testCopyOfRangeFloat() {
    ...
    ret = Arrays.copyOfRange(a1, 2, 4);
    assertEquals(new float[] {-7f, 0f}, ret);

    ret = Arrays.copyOfRange(a1, 3, 6);
    assertEquals(new float[] {0f, 3.75f, 0f}, ret);
  ...
  public void testCopyOfRangeInt() {
    ...
    ret = Arrays.copyOfRange(a1, 2, 4);
    assertEquals(new int[] {7, 5}, ret);

    ret = Arrays.copyOfRange(a1, 3, 6);
    assertEquals(new int[] {5, 1, 0}, ret);
  ...
  public void testCopyOfRangeLong() {
    ...
    ret = Arrays.copyOfRange(a1, 2, 4);
    assertEquals(new long[] {7, 5}, ret);

    ret = Arrays.copyOfRange(a1, 3, 6);
    assertEquals(new long[] {5, 1, 0}, ret);
  ...
  public void testCopyOfRangeShort() {
    ...
    ret = Arrays.copyOfRange(a1, 2, 4);
    assertEquals(new short[] {7, 5}, ret);

    ret = Arrays.copyOfRange(a1, 3, 6);
    assertEquals(new short[] {5, 1, 0}, ret);
  ...
  public void testCopyOfRangeObject() {
    ...
    ret = Arrays.copyOfRange(a1, 2, 4);
    assertEquals(new Object[] {obj2, null}, ret);

    ret = Arrays.copyOfRange(a1, 3, 6);
    assertEquals(new Object[] {null, obj3, null}, ret);
