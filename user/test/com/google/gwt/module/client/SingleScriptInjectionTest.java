...
/**
 * Tests directly including an external script.
 * 
...
public class SingleScriptInjectionTest extends GWTTestCase {
  ...
  public void testScriptExists() {
    assertEquals("yes1", scriptOne());
  }

  /**
   * The native method called here is defined in SingleScriptInjectionTest1.js.
   */
  public static native String scriptOne() /*-{
    return $wnd.scriptOne();
  }-*/;
}
