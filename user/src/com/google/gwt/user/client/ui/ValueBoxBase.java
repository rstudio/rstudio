...
public class ValueBoxBase<T> extends FocusWidget implements
   ...
   *
   * <p>The placeholder will be displayed if this value box is empty
   * and should describe the expected input for this value box.</p>
   *
   * <p>The exact behavior of the placeholder might differ between browsers.</p>
   *
