...
#### Posit Workbench
- The secret key used to sign authorization cookies in environments where Workbench is configured with SSL can now be set via the `WORKBENCH_ENCRYPTION_KEY` environment variable. (rstudio-pro#7169)
