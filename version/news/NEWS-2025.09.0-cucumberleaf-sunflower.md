...
- (rstudio-pro#8289): Removes `pwb_session_duration` from Prometheus Metrics. Session start and end times are available via the new Workbench API endpoint `get_historical_session`
...
- ([#16249](https://github.com/rstudio/rstudio/issues/16249)): Updated copilot-language-server to resolve Copilot-related hangs
...
- (rstudio-pro#6251): Removed the deprecated code, documentation, and server options for Google Auth
