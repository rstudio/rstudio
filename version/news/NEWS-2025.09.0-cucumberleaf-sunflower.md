...
- (rstudio-pro#8289): Removes `pwb_session_duation` from Prometheus Metrics. Session start and end times are available via the new Workbench API endpoint `get_historical_session`
