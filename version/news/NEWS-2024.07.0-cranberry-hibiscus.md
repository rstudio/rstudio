...
- Fixed bug that prevented SCIM-provisioned users from being unlocked after being re-activated when using a license with an unlimited number of seats (rstudio-pro#6561)
