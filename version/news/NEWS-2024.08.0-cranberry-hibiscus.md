## RStudio 2024.08.0 "Cranberry Hibiscus" Release Notes
...
- Fixed a bug where users could not be found via SCIM provisioning due to incorrectly applied pagination parameters when using SCIM filters (rstudio-pro#6608)
