...
- ([#16594](https://github.com/rstudio/rstudio/issues/16594)): Fixed an issue where setting `--ozone-platform` in `electron-flags.conf` could cause RStudio Desktop to open with a blank window on Linux.
