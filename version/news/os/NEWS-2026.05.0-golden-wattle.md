...
- ([#17613](https://github.com/rstudio/rstudio/issues/17613)): Restored the column count in the data viewer status bar (e.g. "Showing 1 to 18 of 100,000 entries, 500 total columns"), which had been dropped from the info bar in the vanilla-JS rewrite (#17382).
