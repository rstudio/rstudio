...
try {
    timestamps {
        def containers = [
          ...
          [os: 'yakkety',  arch: 'amd64',  flavor: 'desktop', variant: 'yakkety'],
          [os: 'yakkety',  arch: 'i386',   flavor: 'desktop', variant: 'yakkety'],
          [os: 'yakkety',  arch: 'amd64',  flavor: 'server',  variant: 'yakkety'],
          [os: 'yakkety',  arch: 'i386',   flavor: 'server',  variant: 'yakkety']
        ]
