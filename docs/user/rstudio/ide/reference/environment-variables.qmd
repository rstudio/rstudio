...
| `RSTUDIO_DISABLE_POSIT_ASSISTANT_INSTALLATION` | Non-empty | Desktop, Server | Prevents you from installing, updating, or uninstalling [Posit Assistant](../guide/tools/posit-ai.qmd) yourself. RStudio uses only the installation your administrator provides, ignores any installation in your own user directory, and does not check for updates. |
