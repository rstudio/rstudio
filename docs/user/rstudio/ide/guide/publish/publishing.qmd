...
### Publishing Destination[\#](https://docs.posit.co/connect/user/publishing/#publishing-destination)

![Publish to RPubs or Connect](https://docs.posit.co/connect/user/images/screenshots/publish-rpubs-or-connect.png){fig-alt="Publish to RPubs or Connect"}
