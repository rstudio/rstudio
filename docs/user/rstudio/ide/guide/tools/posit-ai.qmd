...
::: {.callout-note title="Using Posit Assistant with Workbench"}
With Workbench, a system administrator must first enable Posit Assistant. To enable it, add the following line:
...
To enable Posit Assistant in RStudio:
