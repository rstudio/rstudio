...
In the upper-right corner of the RStudio **Viewer** pane, press the reload button ![](images/reload-button.png){height=30}. This will display the plumber API's rapidoc interface in the **Viewer** pane, allowing for interactive testing with the active plumber API in real time.
