...
Alternatively, in the Shiny `app.R` file, there will also be a **Run App** dropdown. From **Run App**, select **In Background Job** and then press the **Run App** button. This will not have auto-reloading, but might be preferable for Shiny apps with a long startup time.
...
<details><summary>`simulate-pi.R` Code</summary>
