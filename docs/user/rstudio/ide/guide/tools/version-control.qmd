...
Linux and Mac OSX both include SSH as part of the base system. Windows-10 and newer also include an SSH client as an optional Windows component, as does the standard Windows distribution of Git (Git for Windows, referenced above).
