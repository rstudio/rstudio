...
If you have more than 50 columns in your dataset, the data viewer only displays up to 50 columns. To view additional columns, click the single Cols **>** arrow to scroll right (columns are displayed in groups of 50). If you want to jump to the end of your dataset, click the double Cols **>>** arrows.
