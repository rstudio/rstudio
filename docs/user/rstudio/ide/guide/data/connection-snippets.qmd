...
This snippet can be saved on a server-based version of RStudio under `/etc/rstudio/connections/`. Once that file is created and RStudio is restarted, RStudio will make this connection available as:
