...
If several files are opened within RStudio, then they are all available as tabs within the **Source** pane to facilitate quick switching between open documents. If you have a large number of open documents you can also navigate between them using the "**\>\>"** icon at the end of the tab bar or the **View -\> Switch to Tab\...**) menu item:
