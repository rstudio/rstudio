...
-  **Source pane**\
-  **Console pane**\
-  **Environment pane**, containing the **Environment**, **History**, **Connections**, **Build**, and **VCS** tabs\
-  **Output pane**, containing the **Files**, **Plots**, **Packages**, **Help**, **Tutorial**, **Viewer**, and **Presentation** tabs
