...
Help pages often have small code examples. RStudio includes a **Run examples** button inside the **Help** pane. For example, calling `?paste0()` will bring up the `paste0()` documentation in the **Help** pane. Scroll down to the "Examples" section and click on **Run Examples**.

![](images/help-pane.png){fig-alt="The Help pane for the paste0 function. The examples section of the documentation is in focus, with the 'Run Examples' button highlighted."}

This will execute the examples and display their output in the **Help** pane.

![](images/help-pane-examples.png){fig-alt="The Help pane displaying the output of examples for paste function."}
