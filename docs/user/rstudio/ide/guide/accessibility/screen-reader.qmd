...
Some features discussed in this document require RStudio 1.3 or newer. In a few cases you need to know if you are using RStudio Desktop or Posit Workbench / RStudio Server. If RStudio is loaded in your web browser, then you are using Posit Workbench or RStudio Server; otherwise you have RStudio Desktop.
...
Posit Workbench (previously RStudio Server Pro/RStudio Workbench) and RStudio Server Open Source are web-based applications loaded in your preferred browser. To put it simply, you can understand it as an online version of RStudio Desktop.
...
As described in the [basic concept](#basic-concept) above, Posit Workbench and RStudio Server are web-based applications loaded inside your browser.
