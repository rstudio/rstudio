...
Adapted from <https://support.rstudio.com/hc/en-us/articles/360044226673-RStudio-Accessibility-Features>
...
For the purposes of this discussion, "RStudio Server" encompasses both RStudio Server Open Source and RStudio Workbench (previously RStudio Server Pro).
...
More details on RStudio's theming features are in the [Using RStudio Themes article](https://support.rstudio.com/hc/en-us/articles/115011846747-Using-RStudio-Themes).
...
Keyboard shortcuts may be customized using the Tools / Modify Keyboard Shortcuts menu. For more on this, see the [Customizing Keyboard Shortcuts article.](https://support.rstudio.com/hc/en-us/articles/206382178-Customizing-Keyboard-Shortcuts)
