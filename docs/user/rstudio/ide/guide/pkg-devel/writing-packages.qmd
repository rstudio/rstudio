...
![](images/build-reload-pkg.png){fig-alt="The build pane in RStudio, showing the output of a 'Build package' command."}
...
You can also execute **Build and Reload** using a keyboard shortcut <kbd>Ctrl+Shift+B</kbd> as well as configure RStudio to automatically save open source files prior to rebuiling.
