...
![](images/addin-examples.png){alt="Addins Menu" fig-alt="A screenshot of the addinexamples dropdown - displaying the insert, find and replace, reformat R code, and Subset a data frame add-ins."}
