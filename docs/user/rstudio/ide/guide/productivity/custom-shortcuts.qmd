...
Users can customize or bind keyboard shortcuts to execute: - RStudio application commands - Editor commands - User defined R functions or [RStudio Addins](https://rstudio.github.io/rstudioaddins/) or the [`shrtcts`](https://pkg.garrickadenbuie.com/shrtcts/) package
