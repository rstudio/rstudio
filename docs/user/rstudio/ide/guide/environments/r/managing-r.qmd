...
This section is a practical guide on how to set particular options on R startup. General information on how to manage R package environments is available at [Reproducible Environments](https://solutions.posit.co/envs-pkgs/environments/), and a deeper treatment of R process startup is available in [this article](https://rviews.rstudio.com/2017/04/19/r-for-enterprise-understanding-r-s-startup/) or [What They Forgot to Teach You About R](https://rstats.wtf/r-startup.html).
