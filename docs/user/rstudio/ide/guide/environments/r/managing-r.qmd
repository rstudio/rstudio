...
You can override which R version RStudio uses on a Windows machine by navigating to **RStudio Options**  > **General**. 

A **Choose R Installation** dialog displays that allows you to select the version of R to use. This dialog box, pictured below, also appears if you hold down the control/`Ctrl` key at RStudio startup. 
