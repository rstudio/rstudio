...
To expand the folded region, click on the arrow in the gutter or on the icon that overlays the folded code or use the keyboard shortcut <kbd>Ctrl+Alt+Shift+L</kbd>.
...
Arbitrary selections of code can be folded by using **Edit \> Folding \> Collapse** or the keyboard shortcut: **Alt-L**.
...
Note that as illustrated above the line can start with any number of pound signs (#) so long as it ends with a space followed by four or more `-`, `=`, or `#` characters.
