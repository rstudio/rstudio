...
You can run the diagnostics engine over all R files in the project either using the code wizard menu, or by pressing <kbd>Ctrl + Alt + Shift + P</kbd> (<kbd>Cmd + Alt + Shift + P</kbd> on Mac):
