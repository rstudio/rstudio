...
To create a new project in RStudio, use the **Create Project** command (available on the Projects toolbar in the top right corner or on the global toolbar at the top left corner). 
