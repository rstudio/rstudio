...
You can create RStudio projects:
...
2.  Creates a hidden directory (named .Rproj.user) where RStudio stores project-specific temporary files (e.g. auto-saved source documents, window-state, etc.). RStudio also automatically adds this directory to .Rbuildignore, .gitignore, etc. if required.
