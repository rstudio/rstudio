...
Posit Workbench has several features that differentiate it from the open-source [RStudio desktop](https://posit.co/products/open-source/rstudio/) and [RStudio Server](https://posit.co/products/open-source/rstudio-server/), which you can read about on the [Workbench comparison page](https://posit.co/products/enterprise/workbench/). The main advantages of using Posit Workbench are:
...
- [RStudio Desktop Pro](https://posit.co/downloads/) - available for Windows/Mac/Linux
