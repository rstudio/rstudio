| Platform | Download |
|----------|----------|
| Ubuntu 22 / 24 / 26, Debian 13 | [`rstudio-server-{{< var osVersion >}}-amd64.deb`](https://download2.rstudio.org/server/jammy/amd64/rstudio-server-{{< var osVersion >}}-amd64.deb) |
