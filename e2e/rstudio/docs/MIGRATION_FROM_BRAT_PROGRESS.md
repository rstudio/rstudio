...
10. ~~`files-endpoint.R` (1)~~ -- ported 2026-05-20 as `files_endpoint.test.ts`. Drives raw `GET /files/...` via `page.request` with custom Sec-Fetch-Site / Referer headers; `@server_only`
