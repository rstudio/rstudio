/**
 * New Connection wizard: each registered driver appears in the type list,
 * its snippet renders labeled parameter fields (the same path professional
 * drivers take), typing updates the generated code, and Back/Cancel navigate
 * as expected. No database needed: nothing here connects.
 *
...
for (const base of ALL_DB_TARGETS) {
  ...
  test.describe(`New Connection wizard (${target.id})`, () => {
