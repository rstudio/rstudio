...
|---|---|---|---|
| `copy` (default) | unset | Run | Only the host token store (`store/data.json`) copied here; no skills, workspaces, or other state |
