...
- Fixed Update Available can show after user selects to Ignore Update (rstudio/rstudio-pro#4179)
- Fixed Can't update to latest version if version was previously ignored (#12874)
