...
### Fixed
- ([#13292](https://github.com/rstudio/rstudio/issues/13292)): Fixed inline R Markdown table text colors when changing editor themes, including tables with custom backgrounds.
