...
- Fixed a `TypeError` raised during spell-check marker invalidation when an annotation lacked a `text` property; the predicate now null-checks the annotation text before lower-casing it.
