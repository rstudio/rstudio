...
### Fixed
- ([#13292](https://github.com/rstudio/rstudio/issues/13292)): Fixed inline Markdown tables produced by `knitr::kable()` retaining dark text when using a dark editor theme.
