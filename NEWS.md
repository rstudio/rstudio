...
### Fixed
- ([#18744](https://github.com/rstudio/rstudio/issues/18744)): Fixed an issue where running RStudio Desktop and Server together could make a session unable to create documents.
