...
- ([#17333](https://github.com/rstudio/rstudio/issues/17333)): Fixed an issue where the publishing wizard would crash when publishing Quarto documents with Quarto v1.9
