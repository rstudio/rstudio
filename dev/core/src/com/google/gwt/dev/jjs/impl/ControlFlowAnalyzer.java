...
public class ControlFlowAnalyzer {
   ...
   * instantiable.
   */
  private Set<JMethod> methodsLiveExceptForInstantiability = new IdentityHashSet<JMethod>();

  /**
   * See {@link #getMethodsReferencedButNotExecuted()}.
   */
  private Set<JMethod> methodsReferencedButNotExecuted = new IdentityHashSet<JMethod>();
