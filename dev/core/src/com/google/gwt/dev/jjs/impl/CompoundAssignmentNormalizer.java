...
public abstract class CompoundAssignmentNormalizer {
  ...
  /**
   * Decide what expression to return when breaking up
   * a compound assignment of the form <code>lhs op= rhs</code>. The breakup
   * creates an expression of the form <code>lhs = lhs op rhs</code>, and
   * the right hand side of the newly created expression is passed to this
   * method.
   */
