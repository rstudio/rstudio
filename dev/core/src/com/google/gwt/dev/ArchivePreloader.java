...
public class ArchivePreloader {
   ...
   */
  static void preloadArchives(TreeLogger logger, CompilerContext compilerContext) {
    ...
    try {
      Collection<URL> archiveURLs = compilerContext.getModule().getAllCompilationUnitArchiveURLs();
