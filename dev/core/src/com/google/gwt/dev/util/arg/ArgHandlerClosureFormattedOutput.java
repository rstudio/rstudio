...
public class ArgHandlerClosureFormattedOutput extends ArgHandlerFlag {
  ...
  public ArgHandlerClosureFormattedOutput(OptionClosureFormattedOutput option) {
    this.option = option;
  ...
  public boolean setFlag(boolean value) {
    option.setClosureCompilerFormatEnabled(value);
    return true;
  }
  ...
  public boolean getDefaultValue() {
    return option.isClosureCompilerFormatEnabled();
  }
}
