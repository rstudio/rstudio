...
generateQmdHandEditWarning <- function (sourceFile, overlayFile) {
   overlayLine <- if (!is.null(overlayFile) && file.exists(overlayFile)) {
      sprintf("\n(and %s in rstudio/rstudio-pro for Pro-only options)", overlayFile)
   } else {
      ""
   }
   sprintf("<!--
THIS FILE WAS AUTOMATICALLY GENERATED BY A TOOL (generate-options.R) - DO NOT HAND EDIT IT.
To modify these options, edit %s in rstudio/rstudio%s,
then re-run: Rscript scripts/generate-options.R
-->", sourceFile, overlayLine)
}
...
generateQmd <- function (optionsJson, overlayOptionsJson, sourceFile, overlayFile) {
   ...
   qmd <- paste("---",
                ...
                "---",
                "",
                generateQmdHandEditWarning(sourceFile, overlayFile),
                "",
                sep = "\n")
...
generate <- function (optionsFile) {
   ...
   if (identical(generatorType, "ProgramOptions")) {
      ...
      generateQmd(optionsJson, overlayOptionsJson, optionsFile, overlayFile)
   } else {
